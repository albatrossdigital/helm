...
!function() {
    angular.module("app", [ "app.core", "app.flickr", "ui.router", "ngResource", "infinite-scroll", "angularFileUpload", "ngJcrop" ]).run([ "$rootScope", "$state", "$stateParams", "$window", "$location", "$timeout", function($rootScope, $state, $stateParams) {
        ...
        }, $rootScope.$state = $state, $rootScope.$stateParams = $stateParams, $rootScope.$on("$stateChangeSuccess", function() {}), 
    ...
    uploader.onAfterAddingFile = function(fileItem) {
        ...
        Array.prototype.push.apply($rootScope.files[$rootScope.activeField], $scope.selected), 
        jQuery("#" + $rootScope.activeField + "_media").trigger("change"), $scope.selected = [], 
        $state.go("base"), $event.preventDefault();
    };
            ...
            $scope.filters = {
                ...
                $scope.queue = {
                    ...
                    file.$save(function(data) {
                        ...
                        $scope.queue.completed >= $scope.queue.total && (Array.prototype.push.apply($rootScope.files[$rootScope.activeField], $scope.queue.files), 
                        jQuery("#" + $rootScope.activeField + "_media").trigger("change"), $scope.queue = void 0, 
                        $state.go("base"));
                    });
                }), $event.preventDefault();
            };
    ...
    $scope.init = function(params) {
        ...
        if ($rootScope.activeField = fieldName, $rootScope.settings[fieldName] = {}, $rootScope.settings[fieldName].apiUrl = void 0 != params.apiUrl ? params.apiUrl : $rootScope.apiUrl, 
        ...
        } else $rootScope.settings[fieldName].tabs = $rootScope.tabs;
        $rootScope.settings[fieldName].tabs.slice().reverse(), console.log("params", $rootScope.settings[fieldName]);
    }, $timeout(function() {
