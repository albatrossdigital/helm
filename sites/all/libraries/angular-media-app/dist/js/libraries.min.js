...
function(window, angular, undefined) {
    ...
    function createHttpBackendMock($rootScope, $timeout, $delegate, $browser) {
        ...
        function $httpBackend(method, url, data, callback, headers, timeout, withCredentials) {
            ...
            throw new Error(wasExpected ? "No response defined !" : "Unexpected request: " + method + " " + url + "\n" + (expectation ? "Expected " + expectation : "No more request expected"));
        }
        ...
        this.mode = function(mode) {
            switch (mode) {
              ...
              case "rethrow":
                var errors = [];
                handler = function(e) {
                    if (errors.push(1 == arguments.length ? e : [].slice.call(arguments, 0)), "rethrow" === mode) throw e;
        ...
        angular.mock.$$annotate = angular.injector.$$annotate, angular.injector.$$annotate = function(fn) {
            ...
            function workFn() {
                ...
                angular.forEach(moduleFns, function(module) {
                    modules.push(angular.isObject(module) && !angular.isArray(module) ? function($provide) {
    ...
    } ]).controller("JcropController", [ "$scope", "$element", "ngJcropConfig", "$window", function($scope, $element, ngJcropConfig) {
